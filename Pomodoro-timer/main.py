...
def start_timer():
    ...
    if reps % 8 == 0:
        ...
        text.config(text="Working", fg=GREEN)
        count_down(work_sec)
...
location_tomato = PhotoImage(file="tomato.png")
canvas.create_image(100, 112, image=location_tomato)  
timer_text = canvas.create_text(100, 130, text="00:00", fill="white", font=(FONT_NAME, 35, "bold"))

canvas.grid(column=1, row=1)

text = Label(text="Timer", font=(FONT_NAME, 50), fg=GREEN, bg=YELLOW)
